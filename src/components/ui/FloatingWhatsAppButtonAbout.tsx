...
const FloatingWhatsAppButtonAbout = () => {
  const [isExpanded, setIsExpanded] = useState(false);

  // WhatsApp number for About page: +91 9849834102
  const whatsappNumber = "919849834102";
...
export default FloatingWhatsAppButtonAbout;
